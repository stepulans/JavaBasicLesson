...
public class WordSplitter {
    public static void main(String[] args) {
        ...
        System.out.println("Enter first word: (It should contain only even letter number) ");
        String word1 = scanner.next();
        int len = word1.length();
        System.out.println("Amount of first word letter is: " + len);


        System.out.println("Enter second word: (Its should contain only even letter number) ");
